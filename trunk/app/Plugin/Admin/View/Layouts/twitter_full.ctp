...
<html lang="en">
  <head>
    ...
    <!-- Le styles -->
    <?php echo $this->Html->css('/admin/css/twitter/bootstrap.min');?>
    <?php echo $this->Html->script(array(
        '/admin/js/twitter/bootstrap-alerts',
        '/admin/js/twitter/bootstrap-dropdown'
    ));?>
    <style type="text/css">
  ...
  <body>
    ...
    <div class="topbar">
      <div class="fill">
        <div class="container">
          <a class="brand" href="<?php echo $this->Html->url("/");?>">ACL Management</a>
    ...
    <div class="container">
      ...
      <footer>
        <p><a href="">PSCD Co., Ltd</a> &copy; 2015</p>
      </footer>
